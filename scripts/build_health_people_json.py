#!/usr/bin/env python3
"""Build the Media Psychology, Health, & Well-Being people/research feed."""
...
CONFIG_PATH = Path("config/health_people.yml")
...
def main():
    ...
    payload = {
        "title": "People in Media Psychology, Health, & Well-Being",
